# Copied from https://stackoverflow.com/questions/40806225/pyspark-logging-from-the-executor/42982045#42982045
import logging
...
def getLogger(name="executor", logfile="pyspark.log"):
